demo = {
  ...
  initSmallGoogleMaps: function() {
    ...
    // Departure Map
    var myLatlng = new google.maps.LatLng(51.508470, -0.267600);
    var mapOptions = {
      zoom: 15,
      center: myLatlng,
      scrollwheel: false, //we disable de scroll over the map, it is a really annoing when you scroll through page
    ...
    // Destination Map
    var myLatlng = new google.maps.LatLng(51.525471, 0.016910);
      var mapOptions = {
          zoom: 15,
          center: myLatlng,
          scrollwheel: false, //we disable de scroll over the map, it is a really annoing when you scroll through page
    ...
    // Route Map
    var origin = new google.maps.LatLng(51.508470, -0.267600);
      var destination = new google.maps.LatLng(51.525471, 0.016910);
      ...
      var map = new google.maps.Map(document.getElementById("estimatedRouteMap"), mapOptions);
